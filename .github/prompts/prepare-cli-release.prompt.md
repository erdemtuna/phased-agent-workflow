...
- Add an installation section at the end with:
  - Plugin install: `copilot plugin install erdemtuna/paw-discovery` (always installs from `main`)
  - NPM versioned install: `npx @paw-discovery/cli@<version>` and `npm install -g` options
